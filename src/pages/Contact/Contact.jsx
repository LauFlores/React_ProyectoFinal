...
const Contact = () => {
    ...
    return (
        <div className="contact">
            <h1>Contactate con DecoBazarLau</h1>
            <p className='contact__p'>Podés escribirnos en el siguiente formulario o bien al teléfono 1140457142, en nuestro pié de página tenés disponible nuestras redes sociales</p>
